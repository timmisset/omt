...
public class OMTListItemImpl extends ASTWrapperPsiElement implements OMTListItem {

  public OMTListItemImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public OMTVariable getVariable() {
    return findNotNullChildByClass(OMTVariable.class);
  }
